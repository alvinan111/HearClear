...
describe('STORAGE_KEYS', () => {
  ...
  it('包含 FIRST_USE_AT、ONBOARDING_DONE、PRIVACY_AGREED、LAST_AUDIO_PARAMS、AUDIOGRAM、PRESCRIPTION、FEEDBACK_CORRECTION', () => {
    ...
    expect(STORAGE_KEYS.AUDIOGRAM).toBeDefined();
    expect(STORAGE_KEYS.PRESCRIPTION).toBeDefined();
    expect(STORAGE_KEYS.FEEDBACK_CORRECTION).toBeDefined();
  });
});
